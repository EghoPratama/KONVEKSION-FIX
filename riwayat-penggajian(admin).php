		...
		<div class="wrapper">
			...
			<div class="konten">
				...
				<?php
					...
					$tampilkan = mysqli_query($connect, "SELECT * FROM tbl_data INNER JOIN tbl_riwayat  ON tbl_data.id_karyawan = tbl_riwayat.id_karyawan WHERE nama LIKE '%$s%' ORDER BY nama");
